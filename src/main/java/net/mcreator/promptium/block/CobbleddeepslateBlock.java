...
public class CobbleddeepslateBlock extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:cobbleddeepslate")
	public static final Block block = null;
	public CobbleddeepslateBlock(PromptiumModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobbleddeepslate");
		}
