...
public class PuraniumOreBlockBlock extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:puranium_ore_block")
	public static final Block block = null;
	public PuraniumOreBlockBlock(PromptiumModElements instance) {
		super(instance, 62);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("puranium_ore_block");
		}
