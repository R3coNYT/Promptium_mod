...
public class LavadiumblocBlock extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:lavadiumbloc")
	public static final Block block = null;
	public LavadiumblocBlock(PromptiumModElements instance) {
		super(instance, 248);
	}
