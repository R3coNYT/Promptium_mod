...
public class DeepslateBlock extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:deepslate")
	public static final Block block = null;
	public DeepslateBlock(PromptiumModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CobbleddeepslateBlock.block, (int) (1)));
		}
	}
}
