...
public class PromptiumgrassBlock extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:promptiumgrass")
	public static final Block block = null;
	public PromptiumgrassBlock(PromptiumModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("promptiumgrass");
		}
