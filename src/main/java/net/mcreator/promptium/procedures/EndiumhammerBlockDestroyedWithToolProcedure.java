...
public class EndiumhammerBlockDestroyedWithToolProcedure extends PromptiumModElements.ModElement {
	public EndiumhammerBlockDestroyedWithToolProcedure(PromptiumModElements instance) {
		super(instance, 89);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				PromptiumMod.LOGGER.warn("Failed to load dependency entity for procedure EndiumhammerBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				PromptiumMod.LOGGER.warn("Failed to load dependency x for procedure EndiumhammerBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				PromptiumMod.LOGGER.warn("Failed to load dependency y for procedure EndiumhammerBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				PromptiumMod.LOGGER.warn("Failed to load dependency z for procedure EndiumhammerBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				PromptiumMod.LOGGER.warn("Failed to load dependency world for procedure EndiumhammerBlockDestroyedWithTool!");
			return;
		}
