...
public class PuraniumGemItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:puranium_gem")
	public static final Item block = null;
	public PuraniumGemItem(PromptiumModElements instance) {
		super(instance, 63);
	}
