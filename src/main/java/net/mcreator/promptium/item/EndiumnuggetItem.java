...
public class EndiumnuggetItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:endiumnugget")
	public static final Item block = null;
	public EndiumnuggetItem(PromptiumModElements instance) {
		super(instance, 51);
	}
