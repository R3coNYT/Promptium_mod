...
public class PlasticcableItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:plasticcable")
	public static final Item block = null;
	public PlasticcableItem(PromptiumModElements instance) {
		super(instance, 178);
	}
