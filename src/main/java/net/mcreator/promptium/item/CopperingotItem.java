...
public class CopperingotItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:copperingot")
	public static final Item block = null;
	public CopperingotItem(PromptiumModElements instance) {
		super(instance, 167);
	}
