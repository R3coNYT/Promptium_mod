...
public class HellwoodStickItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:hellwood_stick")
	public static final Item block = null;
	public HellwoodStickItem(PromptiumModElements instance) {
		super(instance, 139);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hellwood_stick");
		}
