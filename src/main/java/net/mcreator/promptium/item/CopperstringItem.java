...
public class CopperstringItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:copperstring")
	public static final Item block = null;
	public CopperstringItem(PromptiumModElements instance) {
		super(instance, 169);
	}
