...
public class PlasticfragmentItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:plasticfragment")
	public static final Item block = null;
	public PlasticfragmentItem(PromptiumModElements instance) {
		super(instance, 171);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("plasticfragment");
		}
