...
public class PromptiumstickItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:promptiumstick")
	public static final Item block = null;
	public PromptiumstickItem(PromptiumModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("promptiumstick");
		}
