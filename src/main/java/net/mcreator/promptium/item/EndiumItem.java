...
public class EndiumItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:endium")
	public static final Item block = null;
	public EndiumItem(PromptiumModElements instance) {
		super(instance, 33);
	}
