...
import net.mcreator.promptium.block.PuraniumOreBlockBlock;
import net.mcreator.promptium.PromptiumModElements;

@PromptiumModElements.ModElement.Tag
public class PuraniumArmorItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:puranium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("promptium:puranium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("promptium:puranium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("promptium:puranium_armor_boots")
	public static final Item boots = null;
	public PuraniumArmorItem(PromptiumModElements instance) {
		super(instance, 77);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(PuraniumOreBlockBlock.block, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "puranium_armor";
			}
