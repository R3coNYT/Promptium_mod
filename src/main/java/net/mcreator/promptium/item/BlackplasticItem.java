...
public class BlackplasticItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:blackplastic")
	public static final Item block = null;
	public BlackplasticItem(PromptiumModElements instance) {
		super(instance, 184);
	}
