...
public class ElectricalcableItem extends PromptiumModElements.ModElement {
	@ObjectHolder("promptium:electricalcable")
	public static final Item block = null;
	public ElectricalcableItem(PromptiumModElements instance) {
		super(instance, 180);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("electricalcable");
		}
